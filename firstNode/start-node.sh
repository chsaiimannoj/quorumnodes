...
GETH_ARGS="--datadir /qdata/dd --raft --mine --rpc --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,raft --unlock 0 --password /qdata/passwords.txt --raftjoinexisting _RAFTID_ --rpcport 22000"
